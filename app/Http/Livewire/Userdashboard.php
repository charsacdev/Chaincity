...
class Userdashboard extends Component
{
    ...
    public function mount(){
         ...
         #user dashboard
         $this->selectAsset=PropertyTable::with('Rating')->where(['property_process->status'=>'approved'])
         ...
         ->get();
          ...
          #select city
          $this->selectCity=PropertyTable::where(['property_process->status'=>'approved'])
          ->select('property_city')->distinct()->get();
        
          #select type
          $this->selectyType=PropertyTable::where(['property_process->status'=>'approved'])
    ...
    public function CompleteRegistration(){
        try{
            ...
            elseif($this->state===null){
                ...
                #update profile
                $NewUser=UsersTable::where(['id'=>auth()->user()->id])->update([
