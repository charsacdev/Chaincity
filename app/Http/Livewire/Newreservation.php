...
class Newreservation extends Component
{
    ...
    public function mount(){
        ...
        #asset selecting
        $this->selectAsset=PropertyTable::with('user')->where(['id'=>$this->lastUrlSegment,'property_process->status'=>'approved'])->get();
        ...
        #reviews
        $this->selectReviews=ReviewTables::where(['approval'=>'approved','property_id'=>$this->lastUrlSegment])->with('user')->inRandomOrder()->get();
    ...
    public function Addreservation(){
        try{
            ...
            elseif($this->guest===null){
                ...
                $savedListing=SavedListingTable::create([
                    'user_id'=>auth()->user()->id,
                    'property_id'=>$this->lastUrlSegment,
                    'payment_id'=>'',
