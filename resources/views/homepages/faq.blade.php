      ...
      <div class="overlay">
        ...
        <div class="container">
          <div class="breadcrumb">
            ...
            <p class="support-text">Here are the answers to your questions</p>
          </div>
      ...
      <div class="container faq-ctn">
        ...
        <section class="geit">
          <div class="input-group d-flex align-items-center justify-content-between">
            <div>
              <label for="">Still got questions?</label> <br>
              <select  name="city" class="form-contro d-none"> 
            ...
            <div class="input-group-append">
              <a href="mailto:support@chaincity.io">
                <button class="input-group-text rlf-btn-primary border-0"> 
                  <img src="asset/img/icon-comment.png" width="22px" alt=""> &nbsp; Get in touch
                </button>
              </a>
            </div>
          </div>
