      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="background: #fff;">
          <div class="modal-header border-0">
            <h1 class="modal-title fs-5 text-center" id="staticBackdropLabel" style="color:#D80450;">Agent Profile Verification&nbsp;<i class="bi bi-patch-check-fill"></i></h1>
          ...
          <form class="row g-3 mt-4 complete-registration" wire:submit.prevent='AgentProfile'>
            <h5 class="p-2 fw-bold" style="color:#D80450;">Document Type</h5>
            ...
            <div class="mt-5 mb-3">
              <h5 class="p-2 fw-bold" style="color:#D80450;">ID Front</h5>
               @error('photo1')
            ...
            <div class="mt-5">
              <h5 class="p-2 fw-bold" style="color:#D80450;">ID Back</h5>
              @error('photo2')
                  <p class="text-danger fw-bold">Oh snap, we dont think this is an image.</p>
                @enderror
              <aside class="agent-verify-profile-image">
            ...
            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center pb-3 sub-footer">
                        ChainCity &copy; 2023.
                        Powered by <a href="https://tutapis.com">Tutapis</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        var wordLength = 250;
              ...
              if (window.location.pathname === '/listing') {
                  var addBtn = '<div class="text-start mt-2"> ' +
                            '<a href="/agent/newlisting" class="rlf-btn rlf-btn-primary cta-btn">Create Listing &nbsp; <i class="fa fa-plus"></i></a> ' +
                         '</div>';
...
s1.async=true;
s1.src='https://embed.tawk.to/6585521207843602b804b2d7/1hi8ch7j2';
s1.charset='UTF-8';
