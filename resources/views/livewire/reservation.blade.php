    ...
    <div class="container payments mb-5 px-3">
        <div class="row">
         <div class="col-sm-12">
              ...
              @if(auth()->guard('web')->user()->account_type=="agent")
                <p class="text-muted">Here are persons that have booked your listed property.</p>
              @else
                 <p class="text-muted">Here are all your reservations.</p>
              @endif
         </div>
                ...
                <div class="tab-pane fade show" id="completed" role="tabpanel">
                    ...
                    @foreach ($completed as $item)
                        <tr>
                            ...
                            <td align="center">
                                <button class="border-0 bg-light" wire:click="Property({{$item->id}})" data-bs-toggle="modal" data-bs-target="#reviewModal">
