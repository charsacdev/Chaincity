                  ...
                  <div class="col-sm-12 col-lg-12 p-0">
                                   ...
                                   @endif
                                      ...
                                      <div class="row">
                                        ...
                                        @if(auth()->guard('admin')->user()->account_type=="master")
                                           ...
                                           <div class="col-md-12 mb-4">
                                             <div class="form-group">
                                                  <label for="">Trip Agent Percentage</label>
                                                  <input type="text" name="tripagentpercentage" wire:model="tripagentpercentage" class="form-control" required>
                                             </div>
                                           </div>

                                           <div class="col-md-12 mb-4">
                                             <div class="form-group">
                                                  <label for="">Coinbase Commerce API Key</label>
                                                  <input type="text" name="coinbaseapi" wire:model="coinbaseapi" class="form-control" required>
                                             </div>
                                           </div>
                                        @endif
                                      </div>
                       ...
                       <form wire:submit.prevent="UpdatePassword">
                            <div class="prl-card">
                                 ...
                                 <div class="text-end">
                                   <button type="submit" wire:loading.attr="disabled" class="rlf-btn rlf-btn-primary">Save Changes</button>
                              </div>
                            </div>  
                       </form>
                  </div>
