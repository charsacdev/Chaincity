    ...
    @foreach($selectAsset as $asset)
        <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
          <div class="psr_ctn">
              ...
              <div class="hse_desc" style="border:0px solid green;margin-top:-60px">
                <div class="d-flex align-items-center justify-content-between">
                   ...
                   <form action="" id="completeRegForm" wire:submit.prevent='CompleteRegistration'>
                    ...
                    @endif
                       <div class="row mt-5">
                           ...
                           <button wire:target='CompleteRegistration' wire:loading.attr='disabled' type="submit" id="completeRegBtn"
